...
for book_name in file_names:
    ...
    if ".azw3" in book_name:
        ...
        temp_file = os.listdir(over2)
        zip_temp_path = os.path.join(over2,temp_file[-1],x_path,y_path,book_path,null_path)
        ...
        os.system('winrar a -r -ep1 %s %s'%(full_zip_path,zip_temp_path))
